...
<section id="wizard-prosess" class="container">
    <div class="flex ">
        <div class="">
            <div class="card-body">
        ...
        <div class="">
            <div class="card-body">
                ...
                <p class="card-text">Laporan Anda akan diverifikasi dan diteruskan kepada divisi berwenang.</p>
            </div>
        </div>
        <div class="">
            <div class="card-body">
                ...
                <p class="card-text">Divisi yang terkait akan menindak lanjuti dan membalas laporan Anda.</p>
            </div>
        </div>
        <div class="">
            <div class="card-body">
                ...
                <p class="card-text"> Laporan Anda akan terus ditindak lanjuti hingga terselesaikan.</p>
            </div>
        </div>
    </div>
</section>