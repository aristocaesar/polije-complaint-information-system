    ...
    public function sendAspirasi()
    {
        if (isset($_POST)) {
            ...
            if ($lenDeskripsi > 1024) {
                throw new Exception("Deskripsi aspirasi terlalu panjang");
            ...
            if (isset($_FILES["foto"])) {
                if ($_FILES["foto"]["error"] != 4) {
                    ...
                    $extension = end($file);
                    // Upload File ( 10MB )
                    UploadFile($_FILES, "L-USER-" . $id, 10485760, [], "document/aspirasi");
            ...
            throw new Exception("Informasi pengiriman aspirasi tidak valid");
        }
    }
}
