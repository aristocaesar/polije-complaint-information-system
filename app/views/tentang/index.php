...
<section id="form-lapor" class="mt-[-570px] lg:mt-[-550px]">
    ...
    <div class="container drop-shadow-xl max-w-5xl">
        <div class="bg-white py-11 px-10">
            ...
            <div>
                <p>Labore in dolore magna occaecat id veniam dolore deserunt proident velit nostrud. Ullamco do incididunt et consequat laborum. Labore et mollit esse deserunt laboris ea incididunt exercitation nostrud. Minim incididunt cillum id anim quis qui est.</p>
            </div>
        </div>
    </div>
</section>
